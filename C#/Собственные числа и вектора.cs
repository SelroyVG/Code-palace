// Дана симметричная матрица 3x3. Построить круги Гершгорина, найти собственные числа и собственные вектора.
// После того как круги Гершгорина построены, высчитываем детерминант.
// Затем, используя полученные значения вычисляем коэффициенты p, которые подставим в следующее уравнение: 
// F=λ^3+p_1 λ^2+p_2 λ^1+p_3=0
// Теперь найдём собственные числа, выполняя по оси λ сканирование с маленьким шагом.
// После того как мы нашли собственные числа, найдём собственные векторы.
// Для вычисления каждого из собственных векторов будем отнимать от элементов главной диагонали матрицы значения,
// равные одному из собственных чисел, а затем вычислим собственные вектора используя метод Гаусса.
