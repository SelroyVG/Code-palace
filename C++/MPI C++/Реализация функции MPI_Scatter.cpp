// Для реализации этой функции будем использовать MPI_Send и MPI_Recv. 
// Процесс root содержит в памяти массив, который разделяется на части и рассылается всем процессам. 
// Для возможности пересылки массивов разных типов воспользуемся перегрузкой функций. 
// Внимание! Основная часть кода содержится в заголовочном файле MyScatterFunc.h
