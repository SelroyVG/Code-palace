// Исходное задание:
// Написать программу на MPI, используя конвейерный вид параллелизма. Время изменяется от 0 до 100 с шагом 0.01. 
// Сравнить результаты с однопроцессорным вариантом. Вычислить ускорение.
// Найти изменение распределения температуры со временем в однородной пластине. Коэффициент теплопроводности равен 1.
// Граничные условия:
// u(x,y,0)=22.0
// u(0,y,t)=22.0∙〖y∙e〗^(-2t)
// u(x,N,t)=22.0∙〖x∙e〗^(-3t)
